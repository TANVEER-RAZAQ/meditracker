...
public class BillingService {
    ...
    public void payWithRfid(String rfidUid, Long billingId) {
        ...
        // If all bills for the visit are paid and lab tests completed, mark visit complete
        ...
        boolean anyPendingLab = false;
        // in a fuller impl we would check lab tests too; omitted for brevity
